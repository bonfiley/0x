...
var mainAsync = function () { return __awaiter(_this, void 0, void 0, function () {
    var _this = this;
    var provider, zeroExConfig, zeroEx, relayerApiUrl, relayerClient, EXCHANGE_ADDRESS, wethTokenInfo, zrxTokenInfo, WETH_ADDRESS, ZRX_ADDRESS, addresses, zrxOwnerAddress, wethOwnerAddresses, setZrxAllowanceTxHashes, setWethAllowanceTxHashes, ethToConvert, depositTxHashes, orderbookRequest, orderbookResponse, sortedBids, rates, zrxBalanceBeforeFill, wethBalanceBeforeFill, bidToFill, fillTxHash, zrxBalanceAfterFill, wethBalanceAfterFill;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 9:
                ...
                return [4 /*yield*/, Promise.all(wethOwnerAddresses.map(function (address, index) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    exchangeRate = (index + 1) * 1.1; /* ZRX/WETH */
            ...
            case 11:
                ...
                rates = sortedBids.map(function (order) {
                ...
                console.log(rates);
                return [4 /*yield*/, zeroEx.token.getBalanceAsync(ZRX_ADDRESS, zrxOwnerAddress)];
            case 12:
                zrxBalanceBeforeFill = _a.sent();
                return [4 /*yield*/, zeroEx.token.getBalanceAsync(WETH_ADDRESS, zrxOwnerAddress)];
            case 13:
                wethBalanceBeforeFill = _a.sent();
                console.log('ZRX Before: ' + _0x_js_1.ZeroEx.toUnitAmount(zrxBalanceBeforeFill, zrxTokenInfo.decimals).toString());
                console.log('WETH Before: ' + _0x_js_1.ZeroEx.toUnitAmount(wethBalanceBeforeFill, wethTokenInfo.decimals).toString());
                bidToFill = sortedBids[0];
                return [4 /*yield*/, zeroEx.exchange.fillOrderAsync(bidToFill, bidToFill.takerTokenAmount, true, zrxOwnerAddress)];
            case 14:
                fillTxHash = _a.sent();
            ...
            case 15:
                ...
                return [4 /*yield*/, zeroEx.token.getBalanceAsync(ZRX_ADDRESS, zrxOwnerAddress)];
            case 16:
                zrxBalanceAfterFill = _a.sent();
                return [4 /*yield*/, zeroEx.token.getBalanceAsync(WETH_ADDRESS, zrxOwnerAddress)];
            case 17:
                wethBalanceAfterFill = _a.sent();
                console.log('ZRX After: ' + _0x_js_1.ZeroEx.toUnitAmount(zrxBalanceAfterFill, zrxTokenInfo.decimals).toString());
                console.log('WETH After: ' + _0x_js_1.ZeroEx.toUnitAmount(wethBalanceAfterFill, wethTokenInfo.decimals).toString());
                return [2 /*return*/];
        }
    });
}); };
