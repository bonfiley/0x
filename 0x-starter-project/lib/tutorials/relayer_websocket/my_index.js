...
var custom_orderbook_channel_handler_1 = require("./custom_orderbook_channel_handler");
var mainAsync = function () { return __awaiter(_this, void 0, void 0, function () {
    var provider, zeroExConfig, zeroEx, relayerWsApiUrl, orderbookChannel, EXCHANGE_ADDRESS, wethTokenInfo, zrxTokenInfo, WETH_ADDRESS, ZRX_ADDRESS, zrxWethSubscriptionOpts, orderbookChannelHandler;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                zrxWethSubscriptionOpts = {
                    baseTokenAddress: ZRX_ADDRESS,
                    quoteTokenAddress: WETH_ADDRESS,
                    snapshot: true,
                    limit: 20,
                };
                console.log("Order book handler");
                orderbookChannelHandler = new custom_orderbook_channel_handler_1.CustomOrderbookChannelHandler(zeroEx);
