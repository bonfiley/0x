...
var mainAsync = function () { return __awaiter(_this, void 0, void 0, function () {
    var _this = this;
    var intervalInMs, provider, zeroExConfig, zeroEx, relayerHttpApiUrl, relayerClient, EXCHANGE_ADDRESS, wethTokenInfo, zrxTokenInfo, WETH_ADDRESS, ZRX_ADDRESS, addresses, zrxOwnerAddress, setZrxAllowanceTxHashes, setWethAllowanceTxHashes, exchangeRate, numberOfOrdersSent;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 7:
                ...
                timers_1.setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                    var makerTokenAmount, takerTokenAmount, ONE_HOUR_IN_MS, feesRequest, feesResponse, order, orderHash, ecSignature, signedOrder;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                makerTokenAmount = _0x_js_1.ZeroEx.toBaseUnitAmount(new utils_1.BigNumber(0.01), zrxTokenInfo.decimals);
                                takerTokenAmount = makerTokenAmount.div(exchangeRate).floor();
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, zeroEx.signOrderHashAsync(orderHash, zrxOwnerAddress, false)];
                            case 2:
                                ecSignature = _a.sent();
...
//# sourceMappingURL=generate_new_orders_with_interval.js.map
